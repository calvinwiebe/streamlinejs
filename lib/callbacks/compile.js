                ...
                if (options.noWrite) {
                  return _(null, {
                    ...
                    sourceMap: sourceMap }); } else { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$exports_compileFile__1() {
                        ...
                        return fs.writeFile(dstName, sources.transformed, "utf8", __cb(_, __frame, 82, 6, __then, true)); }); })(function ___(ex, __result) { __catch(function __$exports_compileFile__1() { if (ex) { __then(); } else { _(null, __result); } ; }); }); })(function ___() { __tryCatch(_, function __$exports_compileFile__1() { return (function __$exports_compileFile__1(__then) {

                        if (options.sourceMap) {
                          if (options.prevMap) {
                            sources.sourceMap.applySourceMap(options.prevMap, options.sourceName); } ; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$exports_compileFile__1() {


                                if (options.verbose) { console.log(("streamline: creating: " + mapFile)); } ;
                                return fs.writeFile(mapFile, sources.sourceMap.toString(), "utf8", __cb(_, __frame, 90, 7, __then, true)); }); })(function ___(ex, __result) { __catch(function __$exports_compileFile__1() { if (ex) { __then(); } else { _(null, __result); } ; }); }); })(function ___() { __tryCatch(_, __then); }); } else { __then(); } ; })(__then); }); }); } ; })(_); }, true)); }, true)); }, true), dstName); }, true), path); }, true), path, options); });};
